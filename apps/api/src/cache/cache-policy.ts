...
export const CACHE_KEYS = {
  ports: () => 'ports:all',
  routes: () => 'routes:all',
  routeOptions: () => 'routes:options:master-v2',
  departurePortOptions: () => 'routes:departures:master-v2',
  arrivalPortOptions: () => 'routes:arrivals:master-v2',
  ...
  islands: (keyword?: string) => `islands:all:travel-region-v3:${keyword ?? ''}`,
